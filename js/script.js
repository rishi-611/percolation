...
function func() {
  ...
  if (v == "Connected") {
    connections.innerHTML +=
      "The system percolates after opening " + count + " sites.<br>";
...
function buttonFunction() {
  ...
  minMax.innerHTML = "";
  minMax.innerHTML +=
    "The threshold value for percolation in this " +
    n +
    "X" +
    n +
    " grid is: " +
    mean;
  minMax.innerHTML +=
    "<br>The standard deviation of the percolation threshold is: " + vari;
  minMax.innerHTML +=
    "<br>Value of site vacancy below which no percolation is possible in a " +
    n +
    "X" +
    n +
    " grid is: " +
    X[1];
  minMax.innerHTML +=
    "<br>Value of site vacancy above which " +
    n +
    "X" +
    n +
    " grid always percolates is: " +
    X[X.length - 2];
}
...
function variance(mean, cache, x) {
  // x = number of simulations
  var sum = 0;
  mean = mean;
  for (i = 0; i < cache.length; i++) {
